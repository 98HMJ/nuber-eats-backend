...
const create_restaurant_resolver_1 = require("./dtos/create-restaurant.resolver");
...
__decorate([
    (0, graphql_1.Query)(returns => [restaurant_entitiy_1.Restaurant]),
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [create_restaurant_resolver_1.CreateRestaurantDto]),
    __metadata("design:returntype", Promise)
...
RestaurantResolver = __decorate([
    (0, graphql_1.Resolver)(of => restaurant_entitiy_1.Restaurant),
