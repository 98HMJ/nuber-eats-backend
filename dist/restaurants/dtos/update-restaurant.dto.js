...
const create_restaurant_resolver_1 = require("./create-restaurant.resolver");
let UpdateRestaurantInputType = class UpdateRestaurantInputType extends (0, graphql_1.PartialType)(create_restaurant_resolver_1.CreateRestaurantDto) {
};
